...
class BuyerFAQScreen extends StatefulWidget {
  final FAQCategory? initialCategory;
  final String? initialSearchQuery;

  const BuyerFAQScreen({
    Key? key,
  ...
  @override
  State<BuyerFAQScreen> createState() => _BuyerFAQScreenState();
}

class _BuyerFAQScreenState extends State<BuyerFAQScreen>
  ...
  Future<void> _loadFrequentlyAskedQuestions() async {
    try {
      // Listen to frequently asked questions stream for buyers only
  ...
  List<FAQCategory> _getCustomerCategories() {
    return [
      FAQCategory.account,
      FAQCategory.orders,
          ...
          child: Column(
            children: [
              FAQSearchWidget(
                ...
                hintText: 'Search customer support topics...',
              ),
              const SizedBox(height: 16),
              FAQCategoryFilterWidget(
                categories: _getCustomerCategories(),
